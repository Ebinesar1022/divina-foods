...
const PRODUCT_MASTER = [
  {
    ID: "101",
    Inventory_ID: "19451400000683038",
  },
];
...
const TAX_MASTER = [
  { ID: "1", Tax_ID: "TAX-001", Tax_Name: "GST", Tax_Rate: "5", Status: "Active" },
  { ID: "2", Tax_ID: "TAX-002", Tax_Name: "VAT", Tax_Rate: "10", Status: "Active" },
];
...
const REPORT_DATA: Record<string, any[]> = {
  ...
  [CONFIG.PRODUCT_MASTER_REPORT]: PRODUCT_MASTER,
  ...
  [CONFIG.TAX_MASTER_REPORT]: TAX_MASTER,
